...
\textbf{全数調査}:
本番導入(2026-04-23)から08-17までの116日間，2系統(安定版 / 開発版)の全945 runを対象に，runログ，PR，promote履歴をGitHub APIで全数収集した．
...
また運用上は，開発版に破壊的変更を先行投入し検査で影響規模を定量観測してから安定版へ降ろす，変更前からFAILを予期しその発現範囲が想定に閉じていることを混入なしの証拠として使う(\ref{sec:integrity}節のピン解除)，といった能動的な使い方も定着した．
