# data/ — 発動事例の確定データセット(2026-04-23 〜 2026-08-16 の 116 日間)
...
| `02a`〜`02e-runs-*.md` | ガード FAIL 全 420 run の表。`02e`(07-14〜08-16)は per-source 化後で target 名の後に `[source]` を併記 |
...
- 観測窓は 2026-04-23T00:00Z 〜 08-17T00:00Z の半開区間(= 04-23 〜 08-16 の 116 日間)。
  窓直後の 08-17 00:25 DB run 31981986529 もガード FAIL だが窓外(期間延長時は取り込むこと)
